...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <input class="btn btn-success" type="button" id="btnAjax_<?= $project->Project_ID ?>" value="<?= $project->Project_ID ?>" onclick="showHint(this.id.split('_')[1], 'getProjectTimeRecords')">
